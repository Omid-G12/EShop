  ...
  const handleSubmit = async (event, elements, stripe) => {
    ...
    if(error) {
      ...
      const orderData = {
        ...
        billing: {name: 'Primary', street: shippingData.address1, town_city: shippingData.city, county_state: shippingData.shippingSubdivision, postal_zip_code: shippingData.zip, country: shippingData.shippingCountry},
            ...
            return (
              <form onSubmit={(e) => handleSubmit(e, elements.elements, elements.stripe)}>
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                  ...
                  <Button type='submit' variant='contained'  disabled={!elements.stripe} color='primary'>
